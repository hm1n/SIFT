...
// 근거 스냅샷 조립은 `evidence-fixture.mts`로 옮겼습니다. 이슈 #79의 지연 측정이 같은 근거를
// 써야 하는데, 조립을 스크립트마다 다시 쓰면 같은 PR을 가리키면서 서로 다른 입력을 재게 됩니다.
import { buildSnapshot, stripPatches } from "./evidence-fixture.mjs";
import {
